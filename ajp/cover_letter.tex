...
manuscript ends with four suggested problems.
...
long it can be believed. We are not aware of an undergraduate-level treatment in
which students separate truncation from roundoff, measure each, and connect both
to the Lyapunov exponent. By the Journal's rule of thumb the manuscript is about
five journal pages, and a two-column build is just over six with the references.

Disclosure of artificial-intelligence use: a large language model was used in
preparing this submission. It assisted in drafting and revising the manuscript
text and in writing and debugging the analysis and figure code, working from
our project and under our direction. All results come from our own
simulations, and we checked every statement, number, and reference and take
full responsibility for the content. The same statement appears in the
manuscript's author declarations.
